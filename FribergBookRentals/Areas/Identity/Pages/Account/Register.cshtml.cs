...
namespace WebApplication1.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public virtual string GetCallBackUrl(string userId, string code, string returnUrl = null)
        {
            return Url.Page(
        ...
        public virtual async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    addRoleResult = await _userManager.AddToRoleAsync(user, ApplicationUserRoles.Member);
                    ...
                    if (addRoleResult.Succeeded)
                    {
                        ...
                        var callbackUrl = GetCallBackUrl(userId, code, returnUrl);                       
